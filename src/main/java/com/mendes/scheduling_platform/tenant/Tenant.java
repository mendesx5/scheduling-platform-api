...
public class Tenant { @Id @GeneratedValue(strategy=GenerationType.IDENTITY) private Long id; @Column(nullable=false) private String name; @Column(nullable=false,unique=true) private String slug; private String logoUrl; private String coverUrl; private String primaryColor; private String phone; private String instagram; private String address; @Enumerated(EnumType.STRING) private TenantStatus status=TenantStatus.ACTIVE; private String plan="FREE"; private Instant createdAt=Instant.now(); public enum TenantStatus { ACTIVE, SUSPENDED } }
